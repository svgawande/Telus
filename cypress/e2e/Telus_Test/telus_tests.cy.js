...
context('Actions', () => {
    ...
    it('Should set primary language',function(){
        ...
        cy.xpath('//div[@id="edit-language-form"]//div[contains(text(),"Language*")]//parent::div//parent::div//div[contains(@class, "sui-c-input-dropdown__indicators")]').type('English')
        cy.wait(5000)
    ...
    it('should add other language',function(){
        ...
        cy.xpath('//div[@id="new-language-form"]//div[contains(text(),"Type language and select*")]//parent::div//parent::div//div[contains(@class, "sui-c-input-dropdown__indicators")]').type('apanese (Japan)')
        cy.wait(5000)
        cy.contains('Japanese (Japan)').click()
        cy.xpath('//div[@id="new-language-form"]//div[contains(text(),"Type language and select*")]//parent::div//parent::div//div[contains(@class, "sui-c-input-dropdown__indicators")]').type('{enter}')
        cy.wait(2000)
        cy.xpath('//div[@id="new-language-form"]//div[contains(text(),"Select proficiency level*")]//parent::div//parent::div//div[contains(@class, "sui-c-input-dropdown__indicators")]').click()
        cy.wait(2000)
